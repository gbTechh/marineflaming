...
const fontArray = {
  alpha:   			[ 48, 48, -0.1 ],
	...
	delta:   			[($fontBase * $fontScale) + 4, 26, -0.1 ],//17.5
	delta_md:   	[($fontBase * $fontScale) + 5, 26, -0.1 ],//19.5
	delta_lg:   	[($fontBase * $fontScale) + 6, 26, -0.1 ],//20.5

	epsilon: 			[$fontBase * $fontScale, 21, 0.1 ],//14.5////////////////////////////estandar
	epsilon_md: 	[($fontBase * $fontScale) + 0.5, 22, 0.1 ],//15
	epsilon_lg: 	[($fontBase * $fontScale) + 1, 23, 0.1 ],//15.5

	zeta:    			[($fontBase * $fontScale) - 1, 16, -0.1 ],//13.5
	zeta_md:    	[($fontBase * $fontScale) - 0.5, 16.6, -0.1 ],//14
	zeta_lg:    	[($fontBase * $fontScale), 17, -0.1 ],//14.5

	eta:     			[($fontBase * $fontScale) - 2, 15.5, -0.1 ],//12.5
	eta_md:     	[($fontBase * $fontScale) - 1, 16.2, -0.1 ],//13.5
	eta_lg:     	[($fontBase * $fontScale) - 0.5, 16.5, -0.1 ],//14
...
export const fontSize = {
  ...
  big_tablet:   fontArray.alpha_md,
	...
	tablet_tablet:  fontArray.eta_md,
	...
	tablet_desktop:  fontArray.eta_lg,
}
